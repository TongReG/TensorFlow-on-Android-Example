...
public class MainActivity extends AppCompatActivity {
    ...
    static boolean ISKITENABLE = false;
    ...
    static Camera2Utils camera_fragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MenuItemUtils.init();
        if (sideRecAdapter.getItemCount() == 0) {
        ...
        */
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            btnDetectObject.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (mBitmap != null) {
                        ...
                        Toast.makeText(MainActivity.this, "mBitmap is null.", Toast.LENGTH_SHORT).show();
                    }
            ...
            cameraView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(MainActivity.this, "CameraKit View", Toast.LENGTH_SHORT).show();
                }
            });
